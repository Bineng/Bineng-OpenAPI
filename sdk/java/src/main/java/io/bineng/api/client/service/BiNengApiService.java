package io.bineng.api.client.service;
...
import io.bineng.api.client.domain.general.ServerTime;
 ...
 */
public interface BiNengApiService {

    // General endpoints
    @GET("/openapi/quote/v1/ping")
    @Headers(BiNengConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    Call<Void> ping();
    ...
    @Headers(BiNengConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER)
