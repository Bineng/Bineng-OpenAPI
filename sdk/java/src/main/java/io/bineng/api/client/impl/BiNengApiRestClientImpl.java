...
import io.bineng.api.client.domain.account.*;
import io.bineng.api.client.domain.account.request.*;
import io.bineng.api.client.domain.general.BrokerInfo;
import io.bineng.api.client.domain.market.*;
import io.bineng.api.client.service.BiNengApiService;
 ...
 */
public class BiNengApiRestClientImpl implements BiNengApiRestClient {

    private final BiNengApiService bHexApiService;

    public BiNengApiRestClientImpl(String baseUrl, String apiKey, String secret) {
        bHexApiService = createService(baseUrl, BiNengApiService.class, apiKey, secret);
    }
